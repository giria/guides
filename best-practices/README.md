...
* Avoid `its`, `let`, `let!`, `specify`, and `before` in RSpec.
  * Instead of using these, extract a method that you can pass the thing that
    is different accross the tests. [Example][avoid-let].
  * Understand why these helpers shouldn't be used, but do not re-implement
    their functionality. [Example][use-let].
...
[avoid-let]: ../style/testing/avoid_let_spec.rb#L3-L22
[use-let]: ../style/testing/avoid_let_spec.rb#L24-36
